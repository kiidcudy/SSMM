...
export function GoogleSignInButton({ label = "Continue with Google" }: { label?: string }) {
  return (
    <button
      ...
      className="flex w-full items-center justify-center gap-2 rounded-md border border-[var(--color-border)] bg-white px-3 py-2.5 text-sm font-medium text-gray-800 hover:bg-gray-50"
    >
      <svg width="18" height="18" viewBox="0 0 48 48" aria-hidden>
        ...
        <path
          fill="#1976D2"
          d="M43.6 20.5H42V20H24v8h11.3c-1.1 3.1-3.5 5.5-6.5 6.6l6.2 5.2C38.9 36.9 44 31.4 44 24c0-1.2-.1-2.3-.4-3.5z"
        />
      </svg>
      {label}
    </button>
