...
const en: PageChrome = {
  ...
  apiActions: [
    { action: "services", body: "List all services (id, name, type, category, rate, min, max, refill, cancel)." },
    { action: "add", body: "Place an order: service, link, quantity (+ comments, drip-feed, subscription fields)." },
    { action: "status", body: "Check order status with order id (or comma-separated orders)." },
    { action: "balance", body: "Return your current USD balance." },
    { action: "refill", body: "Request a refill for order id, or comma-separated orders." },
    { action: "refill_status", body: "Check refill status with refill id, or comma-separated refills." },
    { action: "cancel", body: "Cancel one or more orders (orders=id1,id2)." },
  ],
  apiExample: "Example curl",
  servicesNote: "Live catalog from provider · full list inside the dashboard",
  servicesColId: "ID",
