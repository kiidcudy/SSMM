...
import { post as p6 } from "./tiktok-growth-smm-panel-guide-2026";
import { post as p7 } from "./instagram-reels-smm-panel-guide-2026";

export const BLOG_POSTS: BlogPost[] = [p7, p1, p2, p3, p4, p5, p6];
